...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@yogastudio.sirimsl.mongodb.net/?retryWrites=true&w=majority&appName=YogaStudio`;
...
app.get('/', (req, res) => {
    res.send('Yoga Studio Server is running!');
})
